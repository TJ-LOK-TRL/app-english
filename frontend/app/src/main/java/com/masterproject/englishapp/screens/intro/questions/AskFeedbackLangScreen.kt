...
fun AskFeedbackLangScreen(
    ...
    Column(modifier = Modifier.fillMaxWidth().padding(16.dp)) {
        Row(modifier = Modifier.fillMaxWidth()) {
            ...
            Bubble(text = "In which language should I give you feedback?", side = Side.Left)
        }
        Spacer(Modifier.height(24.dp))

        LanguageSelectionList(
            languages = listOf(Language.PT, Language.EN),
...
@Composable
fun AskFeedbackLangScreenPreview() = AskFeedbackLangScreen(null) { }